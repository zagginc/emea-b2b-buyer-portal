...
const getDisplayPrice = ({
  ...
  const newPrice = isProduct
    ? getProductInfoDisplayPrice(price, newProductInfo, backorderEnabled)
    : getVariantInfoDisplayPrice(price, newProductInfo, backorderEnabled);
